//
//  DangGeunLoginViewController_Delegate.swift
//  AhnChiWook_practice
//
...
class DangGeunLoginViewController_Delegate: UIViewController, WelcomeReloginDelegate{
    ...
    private func pushToWelcomeVC() {
        let welcomeViewController = DangGeunWelcomeViewController_Delegate()
